...
const apiClient = axios.create({
  baseURL:
    ...
    "https://api-taskmanagement-qu7m.onrender.com/api",
...
export const tasksApi = {
  ...
  update: (id, task) =>
    apiClient.put(`/tasks/${id}`, task).then((response) => response.data),
  remove: (id) =>
    apiClient.delete(`/tasks/${id}`).then((response) => response.data),
